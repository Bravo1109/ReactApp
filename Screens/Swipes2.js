...
const Users = [
  { id: "1", uri: require('../images/1.jpeg') },
      ...
      if (i < this.state.currentIndex) {
        ...
        return (
          <Animated.View
            ...
            key={item.id} style={[this.rotateAndTranslate, { height: SCREEN_HEIGHT - 170, width: SCREEN_WIDTH, padding: 10, position: 'absolute' }]}>
        ...
        return (
          <Animated.View
            ...
            key={item.id} style={[{
              ...
              height: SCREEN_HEIGHT - 170, width: SCREEN_WIDTH, padding: 10, position: 'absolute'
            }]}>
